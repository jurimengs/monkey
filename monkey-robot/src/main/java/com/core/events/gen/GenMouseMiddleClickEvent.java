...
@Slf4j
@Data
public class GenMouseMiddleClickEvent implements CustomEvent {
    private GenMouseMoveEvent mouseMoveEvent; // 可以将移动事件与点击整合

    private int delay;

    public GenMouseMiddleClickEvent(int delay) {
        this.delay = delay;
    }

    public GenMouseMiddleClickEvent(int delay, GenMouseMoveEvent mouseMoveEvent) {
        this.delay = delay;
