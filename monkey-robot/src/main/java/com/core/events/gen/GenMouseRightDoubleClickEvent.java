...
@Slf4j
@Data
public class GenMouseRightDoubleClickEvent implements CustomEvent {
    private GenMouseMoveEvent mouseMoveEvent; // 可以将移动事件与点击整合
    private int delay;


    public GenMouseRightDoubleClickEvent(int delay) {
        this.delay = delay;
    }

    public GenMouseRightDoubleClickEvent(int delay, GenMouseMoveEvent mouseMoveEvent) {
        this.delay = delay;
